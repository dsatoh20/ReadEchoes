"""
Django settings for ReadEchoes project.
...
MIDDLEWARE = [
    ...
    'accounts.middleware.HerokuRedirectMiddleware',
...
WSGI_APPLICATION = 'ReadEchoes.wsgi.application'
