...
def uploadImage(img_path):
  ...
  cloudinary.uploader.upload(img_path, public_id=filename, unique_filename = False, overwrite=True)

  # Build the URL for the image and save it in the variable 'srcURL'
  srcURL = CloudinaryImage(filename).build_url()
